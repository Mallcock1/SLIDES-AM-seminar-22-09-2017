...
\begin{frame}
\frametitle{Magnetohydrodynamic waves}
\framesubtitle{Diagnosing information about solar plasma}
...
\begin{frame}
\frametitle{Slab structures on the Sun}
\centering
\includegraphics[height=4.4cm]{media/hinode-prominence.jpg}
\\
\vspace*{0.05in}
\includegraphics[height=3.6 cm]{media/sunspot_lightbridge.png}
\hspace*{0.5in}
\includegraphics[height=3.6 cm]{media/granules.jpg}
\vspace*{-0.05in}
\flushright
...
\begin{frame}
\frametitle{Slab eigenmodes}
\framesubtitle{Asymmetric kink surface mode}
\begin{figure}
\hspace*{-1cm}
\includemedia[
  height=0.7\paperheight,
...
\begin{frame}
\frametitle{Slab eigenmodes}
\framesubtitle{Asymmetric sausage surface mode}
\begin{figure}
\hspace*{-1cm}
\includemedia[
  height=0.7\paperheight,
